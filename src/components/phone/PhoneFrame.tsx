 ...
 * - Desktop/tablet (≥ md): moldura visível, fundo gradiente escuro ao redor
 * - Mobile (< md): vira fullscreen sem moldura — usuário já está no celular
 */
  ...
  return (
    <div className="phone-page">
      ...
      <div className="phone-bezel">
        ...
        {/* Botões laterais (decorativo, só desktop) */}
